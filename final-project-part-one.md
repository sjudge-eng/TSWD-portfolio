...
![Rough sketch of pedestrian crash hotspots in Pittsburgh](pittsburgh_pedestrian_crash_sketch.jpg)
...
ChatGPT (AI-based assistant)

## AI acknowledgements
AI was involed in the initial ideation phase for this project. Initially, I had quite a bit of difficulty putting together a project-based topic that was not only interesting to me, but something that I could actually get the data for. After working with AI to land on this being the topic I wanted to pursue, I also turned to AI to specifically locate this dataset ([Allegheny County Crash Data](https://data.wprdc.org/sk/dataset/allegheny-county-crash-data/resource/2c13021f-74a9-4289-a1e5-fe0472c89881?filters=)). Finding usable, reliable, and long-running data has represented one of the most difficult aspects of this project thus far, so AI was very impactful in finding a very hidden, and incredibly useful, dataset on the Allegheny Regional Data Center webpage. Regarding the rough sketch, AI also played a very helpful role in how to work with geo-tagged data in Tableau. I initially had trouble working with the data because it was imported as a dimension and to get it mapped properly, I had to convert these tracked metrics to measures, which opened up the ability to use the Geotagged data within the dataset. So AI played a very helpful role in enabling my desires for the data to actually come to life in the way I wanted for my version 1 of this final project.
