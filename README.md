...
[Part III](final-project-part-three)
   * My final project examines pedestrian-involved crashes in Pittsburgh from 2020–2024, focusing on where crashes cluster, why certain corridors may experience heightened risk, and how the city has responded. Part I established the initial project idea, dataset, research direction, and proposed story structure. Part II developed the storyboard, early Shorthand draft, draft visualizations, and user research process. Part III completed the final data story by refining the visuals, adding city-to-city comparison, expanding local hotspot context, incorporating Pittsburgh’s policy response, and polishing the final narrative.
